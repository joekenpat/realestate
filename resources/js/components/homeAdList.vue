    ...
    <div class="uk-width-1-1 uk-width-3-4@m uk-padding-small">
      ...
      <div>
        <div class="uk-grid-small" uk-grid>
                ...
                >
                  <a :href="`${base_url}/product/view/${product.id}`">
                    <div class="uk-card-media-top ">
                      ...
                      <!--distress start here-->
                      <div
                        v-else-if="product.plan == 'distress'"
                        class="uk-overlay uk-card-default  uk-position-top-left uk-position-small uk-padding-left-remove"
          ...
          <div
            v-show="product_pagination_data.record_count > 9"
...
export default {
  ...
  methods: {
    ...
    load_search_data() {
      this.data_url = `${this.base_url}/api/product/find`;
