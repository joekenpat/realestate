...
<div class="uk-grid-collapse" uk-grid>
  ...
  <div class="uk-width-1-1 uk-width-3-4@m uk-padding-small">
    {{-- {{dd($product)}} --}}
  <Post-Ad-Form form_action="{{route('api_update_product',['product_id'=>$product->id])}}" :init_data="{{$product}}" :categories_data="{{$categories_data}}"></Post-Ad-Form>
    <!-----post ads end here----->
    di
    <div uk-grid>
      ...
      <div class="uk-width-1-2@m uk-width-1-1@s dashboard-main2 my-margin">
        <div class="uk-container uk-padding-remove uk-margin my-container">
          <div class="uk-card uk-card-default uk-card-body uk-padding-small uk-margin-small uk-border-rounded">
            <h5 class=""><b style="color: #87ceeb">Benefits Of Paid Ad</b></h5>
            <hr>
            <ul class=" uk-padding-remove uk-margin-remove">
              <li class=" dashboard-tips"><i class="mdi  mdi-arrow-right-bold-circle"
                  style="color:#adf802; "></i><b class="dashboard-tips">
