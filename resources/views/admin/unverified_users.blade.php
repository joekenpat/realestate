            ...
            <tr>
              ...
              <td>
                <div>
                  ...
                  <a onclick="confirm_action(event, this)" href="{{route('admin_verify_user',['user_id'=>$user->id])}}" style="color:green" uk-tooltip="verify User"
                    class="uk-icon-link uk-margin-small-right" uk-icon="icon:check; ratio:1"></span></a>
                  <a onclick="confirm_action(event, this)" href="#" style="color:red" uk-tooltip="Block User"
